...
public class TicTacToeBoard extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(action == MotionEvent.ACTION_DOWN){
            ...
            //invalidate(); //reload game board (call constructor)
    ...
    private void drawGameBoard(Canvas canvas){
        ...
        for(int r=1; r<3; r++){
            canvas.drawLine(20, cellSize*r, canvas.getWidth()-20, cellSize*r, paint);
        }
    }
    ...
    private void drawHorizontalLine(Canvas canvas, int row, int col){
        canvas.drawLine(col, row*cellSize + cellSize/2f, cellSize*3, row*cellSize + cellSize/2f, paint);
    }

    private void drawVerticalLine(Canvas canvas, int row, int col){
        canvas.drawLine(col*cellSize + cellSize/2f, row, col*cellSize + cellSize/2f, cellSize*3, paint);
    }
